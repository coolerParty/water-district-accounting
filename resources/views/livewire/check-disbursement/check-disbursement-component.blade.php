<div>
    @section('title', 'Check Disbursement Journal')
    <!-- Main content header -->
    <div
                    ...
                    <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col"
                                    class="p-2 text-xs font-medium tracking-wider text-left text-gray-500 uppercase cursor-pointer"
                                    wire:click="sortByColumn('dv_number')">
                                    <div class="flex content-center space-x-4">
                                        <span>DV No.</span>
                                        @if ($sortColumn == 'dv_number' && $sortDirection == 'desc')
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-indigo-700"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                                                d="M14.707 10.293a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L9 12.586V5a1 1 0 012 0v7.586l2.293-2.293a1 1 0 011.414 0z"
                                        ...
                                        @elseif ($sortColumn == 'dv_number' && $sortDirection == 'asc')
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-indigo-700"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                                                d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z"
                                ...
                                <th scope="col"
                                    class="p-2 text-xs font-medium tracking-wider text-left text-gray-500 uppercase cursor-pointer"
                                    wire:click="sortByColumn('check_number')">
                                    <div class="flex content-center space-x-4">
                                        <span>Check No.</span>
                                        @if ($sortColumn == 'check_number' && $sortDirection == 'desc')
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-indigo-700"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                                                d="M14.707 10.293a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L9 12.586V5a1 1 0 012 0v7.586l2.293-2.293a1 1 0 011.414 0z"
                                        ...
                                        @elseif ($sortColumn == 'check_number' && $sortDirection == 'asc')
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-indigo-700"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                                                d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z"
                                ...
                                <th scope="col"
                                    ...
                                    <div class="flex content-center space-x-4">
                                        <span>Amount</span>
                                        @if ($sortColumn == 'amount' && $sortDirection == 'desc')
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-indigo-700"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                                                d="M14.707 10.293a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L9 12.586V5a1 1 0 012 0v7.586l2.293-2.293a1 1 0 011.414 0z"
                                        ...
                                        @elseif ($sortColumn == 'amount' && $sortDirection == 'asc')
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-indigo-700"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                                                d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                <td class="px-2 py-1 whitespace-nowrap">
                                    <div class="text-xs font-medium text-gray-900 md:text-sm">{{ $disbursement->jv_date
                                        }}</div>
                                </td>
                                <td class="px-2 py-1 whitespace-nowrap">
                                    <div class="text-xs font-bold text-gray-900 md:text-sm">{{ $disbursement->jev_no }}
                                    </div>
                                </td>
                                <td class="px-2 py-1 whitespace-nowrap">
                                    <div class="text-xs font-bold text-gray-900 md:text-sm">{{ $disbursement->dv_number
                                        }}
                                    </div>
                                </td>
                                <td class="px-2 py-1 whitespace-nowrap">
                                    <div class="text-xs font-medium text-gray-900 md:text-sm">{{
                                        $disbursement->check_number }}</div>
                                </td>
                                <td class="px-2 py-1 whitespace-nowrap">
                                    <div class="text-xs font-medium text-gray-900 md:text-sm">{{
                                ...
                                <td class="px-2 py-1">
                                    <div class="text-xs font-medium text-gray-900 lg:text-sm">{{ $disbursement->part }}
                                    </div>
                                </td>
                            ...
                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                <td colspan="11" class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">No Check Disbursement Journal Found!
                                    </div>
                                </td>
                            </tr>
                            @endforelse
