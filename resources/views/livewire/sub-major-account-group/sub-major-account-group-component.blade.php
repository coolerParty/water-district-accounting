<div>
    @section('title', 'Sub Major Account Group')
    <!-- Main content header -->
    <div
        class="flex flex-col items-start justify-between pb-6 space-y-4 border-b lg:items-center lg:space-y-0 lg:flex-row">
        <h1 class="text-2xl font-semibold whitespace-nowrap">Sub Major Account Group</h1>
        @can('account-group-create')
        <a href="{{ route('submajoraccountgroup.create') }}"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $account->seq_no }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    ...
                                    <x-link-success href="{{ route('submajoraccountgroup.edit', ['id' => $account->id]) }}"> Edit
                                    </x-link-success>
                                    @can('account-group-delete')
                                    @endcan
                                    <x-link-danger href="#" class="btn btn-danger btn-sm text-light"
                                        onclick="confirm('Are you sure, You want to delete {{ $account->name }}?') || event.stopImmediatePropagation()"
                            ...
                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                ...
                                <td></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">No Sub Major Account Group Found!</div>
                                </td>
                                <td></td>
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                </td>
