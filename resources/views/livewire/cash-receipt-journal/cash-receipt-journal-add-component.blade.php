                                ...
                                <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="transition-all hover:bg-gray-100">
                                            ...
                                            <td class="p-2">
                                                ...
                                                <select name="journals[{{ $index }}][accountCode]"
                                                    ...
                                                    class="block w-full py-2 pr-5 text-sm leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                                            ...
                                            <td class="p-2 w-50 whitespace-nowrap">
                                                <input type="number" step="any" name="journals[{{ $index }}][debit]"
                                                    class="block w-full p-2 text-sm leading-tight text-right text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500 "
                                        ...
                                        <tr class="transition-all bg-gray-400">
                                            <td class="p-2 text-sm whitespace-nowrap" colspan="2">
                                                Total
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                                                <input type="number" step="any"
                                                    value="{{ array_sum(array_column($journals,'debit')) }}"
                                                    class="block w-full p-2 text-sm leading-tight text-right text-gray-700 border border-gray-200 rounded appearance-none bg-gray-50 focus:outline-none focus:bg-white focus:border-gray-500"
                                                    disabled />
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                                                <input type="number" step="any"
