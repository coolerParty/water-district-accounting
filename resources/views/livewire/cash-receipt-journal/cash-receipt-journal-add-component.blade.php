                ...
                <div class="flex flex-wrap mb-6 -mx-3">
                    ...
                    <div class="w-full px-3 md:w-1/2">
                        ...
                        <input id="cod_prev_day" type="number" step="any" placeholder="0.00"
                            ...
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border @error('cod_prev_day') mb-3 border-red-500 @else border-gray-200 focus:border-gray-500 @enderror rounded appearance-none focus:outline-none focus:bg-white">
                ...
                <div class="flex flex-wrap mb-6 -mx-3">
                    <div class="w-full px-3 mb-6 md:w-1/4 md:mb-0">
                        ...
                        <input id="current" type="number" step="any" placeholder="0.00" wire:model="current"
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border @error('current') mb-3 border-red-500 @else border-gray-200 focus:border-gray-500 @enderror rounded appearance-none focus:outline-none focus:bg-white">
                    ...
                    <div class="w-full px-3 mb-6 md:w-1/4 md:mb-0">
                        ...
                        <input id="penalty" type="number" step="any" placeholder="0.00" wire:model="penalty"
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border @error('penalty') mb-3 border-red-500 @else border-gray-200 focus:border-gray-500 @enderror rounded appearance-none focus:outline-none focus:bg-white">
                    ...
                    <div class="w-full px-3 mb-6 md:w-1/4 md:mb-0">
                        ...
                        <input id="arrears_cy" type="number" step="any" placeholder="0.00"
                            ...
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border @error('arrears_cy') mb-3 border-red-500 @else border-gray-200 focus:border-gray-500 @enderror rounded appearance-none focus:outline-none focus:bg-white">
                                ...
                                <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="transition-all hover:bg-gray-100">
                                                ...
                                                <td class="px-3 py-3 whitespace-nowrap">
                                                    <select name="journals[{{ $index }}][accountCode]"
                                                        wire:model="journals.{{ $index }}.accountCode" class="block w-full px-4 py-1 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                                                ...
                                                <td class="px-3 py-3 whitespace-nowrap">
                                                    <input type="number" step="any" name="journals[{{ $index }}][debit]" class="block w-full px-4 py-1 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                                        wire:model="journals.{{ $index }}.debit" />
                                                        @error('journals.{{ $index }}.debit')<p class="text-xs italic text-red-500">{{ $message }}</p>@enderror
                                                </td>
                                                <td class="px-3 py-3 whitespace-nowrap">
                                                    <input type="number" step="any"  name="subTasks[{{ $index }}][credit]" class="block w-full px-4 py-1 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                        ...
                                        <tr class="transition-all bg-gray-400">
                                            ...
                                            <td class="px-3 py-3 whitespace-nowrap">
                                                <input type="number" step="any" value="{{ array_sum(array_column($journals,'debit')) }}" class="block w-full px-4 py-1 pr-8 leading-tight text-gray-700 border border-gray-200 rounded appearance-none bg-gray-50 focus:outline-none focus:bg-white focus:border-gray-500"
                                                    disabled />
                                            </td>
                                            <td class="px-3 py-3 whitespace-nowrap">
                                                <input type="number" step="any" value="{{ array_sum(array_column($journals,'credit')) }}"  class="block w-full px-4 py-1 pr-8 leading-tight text-gray-700 border border-gray-200 rounded appearance-none bg-gray-50 focus:outline-none focus:bg-white focus:border-gray-500"
                                                    disabled />
                                            </td>
                                            <td class="px-3 py-3 whitespace-nowrap">
