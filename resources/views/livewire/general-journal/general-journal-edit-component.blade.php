<div>
    @section('title', 'General Journal / Edit / JEV No. '. $jev_no)
    <!-- Main content header -->
    <div
            ...
            <form class="w-full" wire:submit.prevent="update">
                ...
                <div class="flex flex-wrap mb-6 -mx-3">
                    <div class="w-full px-3">
                        ...
                        <textarea id="g_particulars" placeholder="Enter GJ particulars" wire:model="g_particulars"
                            rows="5"
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border @error('g_particulars') mb-3 border-red-500 @else border-gray-200 focus:border-gray-500 @enderror rounded appearance-none focus:outline-none focus:bg-white"></textarea>
