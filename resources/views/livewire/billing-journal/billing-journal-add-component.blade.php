<div>
    ...
    <div
        ...
        <h1 class="text-lg font-semibold whitespace-nowrap">
            Billing Journal <span class="text-base text-gray-400">/</span>
            ...
            <form class="w-full" wire:submit.prevent="store">
                ...
                <div class="flex flex-wrap -mx-3">
                    <div class="w-full px-3 mb-6 md:w-1/4">
                        ...
                        <input id="official_receipt" type="text" placeholder="Zone" value="{{ old('zone') }}"
                            wire:model="zone"
                    ...
                    <div class="w-full px-3 mb-6 md:w-1/4 md:mb-0">
                        ...
                        <input id="metered_sales" type="number" min="0" placeholder="Metered Sales"
                            wire:model="metered_sales"
                    ...
                    <div class="w-full px-3 mb-6 md:w-1/4">
                        ...
                        <input id="residential" type="number" min="0" placeholder="Residential" wire:model="residential"
                ...
                <div class="flex flex-wrap mb-6 -mx-3">
                    ...
                    <div class="w-full px-3 mb-6 md:w-1/4 md:mb-0">
                        ...
                        <input id="comm_b" type="number" min="0" placeholder="Commercial B" wire:model="comm_b"
                    ...
                    <div class="w-full px-3 mb-6 md:w-1/4 md:mb-0">
                        ...
                        <input id="comm_c" type="number" min="0" placeholder="Commercial C" wire:model="comm_c"
                    ...
                    <div class="w-full px-3 mb-6 md:w-1/4 md:mb-0">
                        ...
                        <input id="government" type="number" min="0" placeholder="Government" wire:model="government"
                                ...
                                <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="transition-all bg-gray-400">
                                            ...
                                            <td class="p-2 whitespace-nowrap">
                                                <input type="number" step="any" min="0" value="{{
                                                        array_sum(
                                                            array_column(
                                                                $journals,
                                                                'debit'
                ...
                <section class="max-w-4xl p-2 mx-auto dark:bg-gray-800">
                    ...
                    <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="transition-all hover:bg-gray-100">
                                <td class="p-2">
                                    <button type="button" wire:click.prevent="selectAccount({{ $item->id }})"
                                        class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
                                        Select
                                    </button>
                                </td>
                                <td class="p-2 text-xs dark:text-white">
                                    {{ $item->code }}
                                </td>
                                <td class="p-2 text-xs dark:text-white">
                                    {{ $item->name }}
                            ...
                            @empty
                            <tr>
                                <td colspan="3" class="p-2 dark:text-white">
                                    No item found!
                                </td>
                            </tr>
                            @endforelse
