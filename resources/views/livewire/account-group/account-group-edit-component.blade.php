<div>
    ...
    <div
        ...
        <h1 class="text-lg font-semibold whitespace-nowrap">Account Group <span class="text-base text-gray-400">/</span> Edit <span class="text-base text-gray-400">/</span> <span
        ...
        <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            ...
            <form wire:submit.prevent="update">
                ...
                <div class="mt-4">
                    ...
                    <select id="type" name="type" autocomplete="type-name" wire:model="type" class="block w-full px-4 py-2 mt-2 bg-white border border-gray-200 rounded-md shadow-sm dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:outline-none focus:ring focus:border-blue-400 dark:focus:border-blue-300 sm:text-sm">
