...
class MaterialIssuedJournalComponent extends Component
{
    ...
    public function render()
    {
        $mijs = DB::table('material_issued_journals')
            ...
            ->select('material_issued_journals.id as mid', 'rsmi_no', 'journal_entry_vouchers.jv_date as jdate', 'journal_entry_vouchers.jev_no as jno', 'journal_entry_vouchers.code_id as jid', 'journal_entry_vouchers.particulars as part')
